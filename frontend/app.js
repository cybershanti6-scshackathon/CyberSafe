...
function brandMarkup(){
  return `<a class="brand" href="${CYBERSURE.routes.home}" aria-label="CyberSure home">
    <div class="logo-mark" id="logoMark"><img src="/static/logo.svg" alt="CyberSure" onload="this.parentElement.classList.add('has-logo')" onerror="this.style.display='none';this.nextElementSibling.style.display='grid'"><span style="display:none">CS</span></div><span class="brand-name">CyberSure</span>
  </a>`;
}
