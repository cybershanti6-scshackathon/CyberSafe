...
const CYBERSURE = {
  routes: {
    ...
    configConverter: "converter.html",
    nes: "nes.html",
    rpp: "rpp.html",
...
function pageKey() {
  ...
  if (file.includes("converter")) return "configConverter";
...
function brandMarkup() {
  return `<a class="brand" href="${CYBERSURE.routes.home}" aria-label="CyberSure home">
    <div class="logo-mark has-logo" id="logoMark" style="background:transparent;box-shadow:none;"><img src="/static/logo.svg" alt="CyberSure" style="width:40px;height:40px;object-fit:contain;border-radius:10px;"></div><span class="brand-name">CyberSure</span>
  </a>`;
}
...
function navMarkup() {
  ...
  const items = [
    ...
    ["configConverter", "swap_horiz", "Config Converter"],
    ["nes", "shield", "NES"],
    ["rpp", "policy", "RPP"],
